...
public class ContatoClass {
    ...
    public ContatoClass(String codigo, String nome, String tipoContato, Boolean isFavorito, String telefone, String celular, String fax, String observacao, String nomeEmpresa, String cargoEmpresa) {
        this.codigo = codigo;
        this.nome = nome;
